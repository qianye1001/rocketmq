...
public class RocksDBTopicConfigManagerCustomPathTest {

    private BrokerController brokerController;
    private String storePath;
    private String customRocksDBPath;
    ...
    public void init() {
        ...
        customRocksDBPath = storePath + File.separator + "custom" + File.separator + "rocksdb" + File.separator;
        UtilAll.ensureDirOK(customRocksDBPath);
    }
    ...
    public void testConstructorWithCustomPath() {
        ...
        RocksDBTopicConfigManager manager = new RocksDBTopicConfigManager(brokerController, false, customRocksDBPath);
    ...
    public void testConstructorWithNullCustomPath() {
        ...
        RocksDBTopicConfigManager manager = new RocksDBTopicConfigManager(brokerController, false, null);
        Assert.assertNotNull("Manager should be created successfully", manager);
    ...
    public void testDefaultConstructor() {
        ...
        RocksDBTopicConfigManager manager = new RocksDBTopicConfigManager(brokerController);
        Assert.assertNotNull("Manager should be created successfully", manager);
