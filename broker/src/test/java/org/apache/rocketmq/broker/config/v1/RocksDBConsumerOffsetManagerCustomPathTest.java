...
public class RocksDBConsumerOffsetManagerCustomPathTest {
    ...
    public void testConstructorWithCustomPath() {
        ...
        RocksDBConsumerOffsetManager manager = new RocksDBConsumerOffsetManager(brokerController, false, customStorePath);
    ...
    public void testConstructorWithNullCustomPath() {
        ...
        RocksDBConsumerOffsetManager manager = new RocksDBConsumerOffsetManager(brokerController, false, null);
        Assert.assertNotNull("Manager should be created successfully", manager);
