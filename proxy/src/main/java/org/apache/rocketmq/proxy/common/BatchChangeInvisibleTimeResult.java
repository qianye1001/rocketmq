...
public class BatchChangeInvisibleTimeResult {
    ...
    public BatchChangeInvisibleTimeResult(ReceiptHandleMessage receiptHandleMessage, AckResult ackResult) {
        this.receiptHandleMessage = receiptHandleMessage;
        this.ackResult = ackResult;
    }

    public BatchChangeInvisibleTimeResult(ReceiptHandleMessage receiptHandleMessage, ProxyException proxyException) {
        this.receiptHandleMessage = receiptHandleMessage;
